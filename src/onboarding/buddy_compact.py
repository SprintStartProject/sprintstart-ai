...
Nothing the hire is waiting on may call this. The backend runs it after a
...
_COMPACT_SYSTEM = (
    ...
    # Deliberately role-neutral rather than templated per role: this note is read
...
def compact_memory(
    ...
    """
    # Filtered on the *stripped* content, not on the raw field. The version this
