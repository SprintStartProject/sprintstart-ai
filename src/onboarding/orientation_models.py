...
Three properties characterise a packet, and every one of them is deliberate:
...
* **Disposable.** Nothing here is versioned, reviewed or approved. Regenerating
  ...
  orientation.
* **Nothing ships without a source.** Every section states something about
  *this* codebase, so a section that cites nothing is dropped. That hard rule is
  what makes this assembly rather than generation.
"""
...
class OrientationProvenance(BaseModel):
    """Why a packet looks the way it does."""
